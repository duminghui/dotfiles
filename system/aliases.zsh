...
alias pip2_u='pip2 install --upgrade'
alias pip3_o='pip3 list -o --format=columns'
alias pip3_u='pip3 install --upgrade'
alias proxy_on='export http_proxy=http://localhost:1087;export https_proxy=$http_proxy'
...
alias go_get_gocode='go get -v -u github.com/mdempsky/gocode'
