...
name_icon '"applications \(parallels\)"' '󰕶'
name_icon 'applications' '󰀻'
name_icon 'android' '󰀲'
name_icon '\.zshenv' ''
...
extension_icon 'bash' '󱆃'
extension_icon 'bashrc' '󱆃'
extension_icon 'bash_profile' '󱆃'
extension_icon 'bash_history' '󱆃'
