...
# https://github.com/edheltzel/dotfiles/blob/master/fish/.config/fish/utils/color-map.sh
# Set the test text
TEXT='gYw'
TEXT_COL="\033[m"
RESET='\033[0m'
...
function color_map_16_bit() {
  ...
  for BG in $base_colors; do echo -en "$EINS \033[$BG       \033[0m"; done
  echo
  for BG in $base_colors; do printf " \033[1;30m\033[%b  %b  \033[0m" $BG $BG; done
  echo
  for BG in $base_colors; do echo -en "$EINS \033[$BG       \033[0m"; done
  echo
}
